...
(function() {
  ...
  var A, C, H, M, Q, S, State, U, changeState, currentState, eng, getCtx, getModel, getPlayer, getState;
  ...
  S.dockMode = {
    ...
    draw: function(ctx) {
      ...
      return H.drawText(ctx, "Press [Escape] to launch.", ctx.canvas.width / 2, ctx.canvas.height / 2 + 250, 15);
    },
    update: function(dt) {},
    input: function(type, data) {
      if (type === "keydown") {

...
(function() {
  ...
  var A, B, C, DestructibleEntity, E, Entity, EphemeralEntity, H, MovingEntity, NavPointEntity, PlayerShipEntity, RockEntity, ShipEntity,
  ...
  NavPointEntity = (function(superClass) {
    ...
    function NavPointEntity(name1) {
      ...
      this.visible = this.friendly && this.active;
  ...
  E.PlayerShip = function() {
    var playerShip;
    playerShip = new PlayerShipEntity("ray", "civ", H.origin, H.HALFPI, H.pt.setXY(0, 0.5), 0);
    return playerShip;
  };

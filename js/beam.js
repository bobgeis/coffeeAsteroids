...
(function() {
  "Beam\n\n";
  var A, B, Beam, C, DisruptorBeam, H, TargetingBeam, TractorBeam,
  ...
  TractorBeam = (function(superClass) {
    ...
    function TractorBeam(pos1, pos2) {
      TractorBeam.__super__.constructor.call(this, H.newLineSS(pos1, pos2));
      this.phases = C.tracBeamColors.length;
      this.age = 0;
      this.wid = C.beamWidths[0];
      this.color = C.beamColors[0];
    }
    ...
    TractorBeam.prototype.update = function(dt) {
      var phase;
      phase = Math.floor(this.age / C.tracBeamDuration * this.phases);
      this.wid = C.tracBeamWidths[phase];
      this.color = C.tracBeamColors[phase];
      if (this.age > C.tracBeamDuration) {
        return this.alive = false;
      }
      this.age += dt;
      return TractorBeam.__super__.update.call(this, dt);
    };
  ...
  B.newTractorBeam = function(pos1, pos2) {
    return new TractorBeam(pos1, pos2);
  };
